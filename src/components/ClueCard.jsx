...
export const ClueCard = ({ name, onClose }) => {
  ...
  return (
    <div 
      ...
      className={`CARD-IMAGE  fixed left-0 top-0 bottom-0 right-0  p-2  bg-blue-950 rounded-sm text-xl text-white flex justify-center items-center duration-150 z-50 animate-fade-in`}>
