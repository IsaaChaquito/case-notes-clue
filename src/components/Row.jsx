  ...
  return (
    <div className="CLUE-SUSPECTS h-7 flex items-center select-none">
      <h1 
        ...
        className={`min-w-28 h-full text-black text-sm text-nowrap text-center cursor-pointer  ${labelColor} ${labelLineThrough ? 'line-through decoration-8' : 'no-underline'} p-1 `}>
        {label}
      </h1>
      {
