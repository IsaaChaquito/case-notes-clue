...
export const Card = ({ numberOfPlayers = 6 }) => {
  ...
  return (
    <div className="CARD max-w-[400px] w-full mb-5 sm:w-full h-auto sm:rounded bg-white dark:bg-black/60 dark:border-0 text-black dark:text-white sm:border-2 border-black/60 dark:border-transparent flex flex-col overflow-hidden">
